...
func (v *Vehicle) showDetailsTwo() {
	fmt.Println("Number of passengers:", v.NumberOfPassengers)
	fmt.Println("Number of wheels:", v.NumberOfWheels)
}

func (v *Vehicle) changeNumberOfWheels() {
	v.NumberOfWheels = 22
}

func (v Vehicle) changeNumberOfWheelsTwo() {
	v.NumberOfWheels = 33
}
...
func main() {
	...
	suv2.changeNumberOfWheels()
	suv2.showDetails()
	fmt.Println("Resultado 2")
	suv2.changeNumberOfWheelsTwo()
	suv2.showDetails()
	fmt.Println("---------------------------------------")
